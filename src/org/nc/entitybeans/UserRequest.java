...
public class UserRequest {
	...
	@Column(name="Manager_approval",nullable=false,length=2)
	private int Manager_approval;	
	...
	@Column(name="manager_id_fk", nullable=true, length=10)
	...
	public int getManager_approval() {
		return Manager_approval;
	}

	public void setManager_approval(int manager_approval) {
